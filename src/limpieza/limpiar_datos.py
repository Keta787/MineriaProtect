...
Como ejecutar:
    python src/limpieza/limpiar_datos.py
...
RAIZ = _raiz_proyecto()
ORIGEN = RAIZ / "data" / "01_raw"
DESTINO = RAIZ / "data" / "02_interim"
...
def main() -> None:
    if not ORIGEN.exists():
        ...
        print("Crea la estructura data/01_raw/ y coloca ahi los archivos.")
        return

    DESTINO.mkdir(parents=True, exist_ok=True)

    # Deteccion automatica de archivos (recorre subcarpetas de 01_raw/)
